        ...
        <div class="col-md-5 kanan">
            <div class="auth-form-light text-left">
                <div class="brand-logo d-flex justify-content-start mb-5">
                    ...
                    <h3 class="align-self-center ml-3 font-weight-bold">E-Surat Polindra</h3>
                </div>
                <h6 class="font-weight-light mb-5">Silahkan sign-in untuk melanjutkan</h6>
                <form class="" method="post" action="{{ route('auth.login') }}">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-block btn-primary btn-lg font-weight-medium" type="submit">SIGN
                            IN</button>
                    </div>
