...
<head>
    ...
    <link rel="resource" type="application/l10n" href="{{ asset('assets/js/pdfjs-dist/locale.properties') }}">
    {{-- <script src="{{ asset('assets/js/pdf/pdf.js') }}"></script> --}}

    <link rel="stylesheet" href="{{ asset('assets/js/pdf/viewer.css') }}">

    <script src="{{ asset('assets/js/pdfjs-dist/viewer.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('assets/js/pdf/pdf_viewer.css') }}">
    <script src="{{ asset('assets/js/pdfjs-dist/build/pdf.js') }}"></script>
    <script src="{{ asset('assets/js/pdfjs-dist/web/pdf_viewer.js') }}"></script>
</head>
...
<body tabindex="1">
                    ...
                    <div id="toolbarViewer">
                        <div id="toolbarViewerLeft">
                            ...
                            <input type="number" id="pageNumber" class="toolbarField" title="Page"
                                value="1" min="1" tabindex="15" data-l10n-id="page"
                                autocomplete="off">
                        ...
                        <div id="toolbarViewerRight">
                            ...
                            <div id="editorModeButtons" class="splitToolbarButton toggled" role="radiogroup">
                                <button id="editorStamp" class="toolbarButton hidden" disabled="disabled"
                                    title="Image" role="radio" aria-checked="false" tabindex="34"
                                ...
                                <button id="editorFreeText" class="toolbarButton" disabled="disabled" title="Text"
                                    ...
                                    tabindex="35" data-l10n-id="editor_free_text2">
                                ...
                                <button id="editorInk" class="toolbarButton" disabled="disabled" title="Draw"
                                    ...
                                    tabindex="36" data-l10n-id="editor_ink2">
    ...
    <script>
        ...
        pdfjsLib.GlobalWorkerOptions.workerSrc = "{{ asset('assets/js/pdfjs-dist/build/pdf.worker.js') }}";

        const CMAP_URL = "{{ asset('assets/js/pdfjs-dist/cmaps/') }}";
        const CMAP_PACKED = true;

        const DEFAULT_URL = `{!! $pdfData !!}`;
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/js/pdfjs-dist/web/pdf_viewer.css') }}">
    <script src="{{ asset('public/assets/js/pdfjs-dist/build/pdf.js') }}"></script>
    <script src="{{ asset('public/assets/js/pdfjs-dist/web/pdf_viewer.js') }}"></script>
</head>
<body tabindex="1">
    ...
    <script>
        ...
        pdfjsLib.GlobalWorkerOptions.workerSrc = "{{ asset('public/assets/js/pdfjs-dist/build/pdf.worker.js') }}";

        const CMAP_URL = "{{ asset('public/assets/js/pdfjs-dist/cmaps/') }}";
        const CMAP_PACKED = true;

        const DEFAULT_URL = "{{ asset('public/storage/document/oke.pdf') }}";
        const PAGE_TO_VIEW = 1;
        const SCALE = 1.0;
