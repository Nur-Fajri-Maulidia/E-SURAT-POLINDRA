...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    @include('pages.tte.document.visum-umum.view')
                    ...
                    <ul class="list-unstyled">
                        ...
                        @endforeach
                        <li class="list-item mb-2">
                            <b>Download VIsum Sebelum TTE</b>
                            <br>
                            <a href="{{ route('documents.tte.visum-umum.download-before-tte', [
                                'uuid' => $item->uuid,
                            ]) }}"
                                class="btn btn-success btn-sm">Download</a>
                        </li>
                        ...
                        @if ($item->tte_visum_umum_created)
                            ...
                            <li class="list-item mb-2">
                                ...
                                <br>
                                <a class="btn btn-success btn-sm" href="{{ route('documents.tte.visum-umum.download', ['uuid' => $item->uuid]) }}"></a>
                            </li>
                        @endif
                    </ul>
...
@push('scripts')
    <script>
        function showView(uuid) {
            ...
            $.ajax({
                url: '{{ route('documents.tte.vu.get', ['uuid' => $item->uuid]) }}', // Ganti dengan URL yang sesuai
                type: 'GET',
        ...
        function download(uuid) {
            $.ajax({
                url: '{{ route('documents.tte.visum-umum.download', ['uuid' => $item->uuid]) }}',
                type: 'GET',
                xhrFields: {
                    responseType: 'blob'
                },
                success: function(blob) {
                    ...
                    a.href = url;
                    a.download = 'Surat_TTE_' + uuid + '.pdf';
