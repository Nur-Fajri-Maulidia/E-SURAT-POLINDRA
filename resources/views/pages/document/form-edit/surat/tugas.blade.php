<div class="d-cat-tugas col-md-12 mt-5 mb-3">
    <h5><u><b>Form Surat Tugas</b></u></h5>
    <div class="row">
        <div class="d-cat-tugas col-md-12">
            <div class="row">
                <div class="col-md-4 form-group mb-3">
                    ...
                    <textarea name="pembuka" placeholder="Input Kalimat Pembuka Surat.." rows="10"
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text"> {{ $item->tugas[0]->pembuka }}</textarea>
                </div>
                <div class="col-md-4 form-group mb-3">
                    <label for="body" class="mb-2">Isi<sup class="text-danger">*</sup></label>
                    <textarea name="isi" placeholder="Input Isi Surat Tugas.." rows="10"
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text"> {{ $item->tugas[0]->isi }}</textarea>
                </div>
                <div class="col-md-4 form-group mb-3">
                    ...
                    <textarea name="penutup" placeholder="Input Kalimat Penutup Surat.." rows="10"
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text"> {{ $item->tugas[0]->penutup }}</textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 form-group mb-3">
                    <label for="body" class="mb-2">Kota Asal<sup class="text-danger">*</sup></label>
                    <input value="{{ $item->tugas[0]->from }}" name="from" placeholder="Input Kota Asal.."
                ...
                <div class="col-md-3 form-group mb-3">
                    ...
                    <input value="{{ $item->tugas[0]->from_time }}" name="from_time" placeholder="Input Waktu Keberangkatan.."
                ...
                <div class="col-md-3 form-group mb-3">
                    ...
                    <input value="{{ $item->tugas[0]->to }}" name="to" placeholder="Input Kota Tujuan.."
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text">
                </div>
                <div class="col-md-3 form-group mb-3">
                    <label for="body" class="mb-2">Estimasi Waktu Sampai<sup class="text-danger">*</sup></label>
                    <input value="{{ $item->tugas[0]->to_time }}" name="to_time" placeholder="Input Estimasi Waktu Sampai.."
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="datetime-local">
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 form-group mb-3">
                    ...
                    <input value="{{ $item->tugas[0]->tempat }}" name="tempat" placeholder="Input Detail Tempat.."
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text">
                </div>
                <div class="col-md-3 form-group mb-3">
                    <label for="body" class="mb-2">Awal Waktu Pembukaan<sup class="text-danger">*</sup></label>
                    <input value="{{ $item->tugas[0]->from_time }}" name="pembukaan1" placeholder="Input Waktu Awal Pembukaan Surat.."
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="datetime-local">
                </div>
                <div class="col-md-3 form-group mb-3">
                    <label for="body" class="mb-2">Akhir Waktu Pembukaan<sup class="text-danger">*</sup></label>
                    <input value="{{ $item->tugas[0]->to_time }}" name="pembukaan2" placeholder="Input Waktu Akhir Pembukaan Surat.."
                ...
                <div class="col-md-3 form-group mb-3">
                    ...
                    <input value="{{ $item->tugas[0]->biaya }}" name="biaya" placeholder="Input Biaya Perjalanan Dinas.."
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text">
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3 form-group mb-3">
                    ...
                    <input value="{{ $item->tugas[0]->alat }}" name="alat" placeholder="Input Angkutan yang digunakan.."
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text">
                </div>
                <div class="col-md-6 form-group mb-3">
                    <label for="body" class="mb-2">Catatan Lainnya</label>
                    <textarea name="catatan" placeholder="Input Catatan Lainnya.." rows="10"
                        class="s-tugas form-control @error('body') is-invalid @enderror" type="text">{{ $item->tugas[0]->catatan }}</textarea>
                </div>
            </div>
            <hr>
            <div class="row">
                <div class="col-md-6 form-group mb-3 mt-2">
                    <span>Detail Tujuan </span>
                </div>
            </div>
            @foreach ($item->tugas[0]->tujuan as $tujuan)
            <div class="row mb-3">
                <div class="col-md-3 form-group mb-3">
                    <label for="berangkat" class="mb-2">Berangkat Dari</label>
                    <input value="{{ $tujuan->from }}" id="berangkat" name="from_detail[]" placeholder="Input Keberangkatan.."
                        class="s-tugas form-control" type="text">
                </div>
                <div class="col-md-3 form-group mb-3">
                    <label for="waktu-berangkat" class="mb-2">Waktu Keberangkatan</label>
                    <input value="{{ $tujuan->from_time }}" id="waktu-berangkat" name="from_time_detail[]" placeholder="Input Waktu Keberangkatan.."
                        class="s-tugas form-control" type="datetime-local">
                </div>
                <div class="col-md-3 form-group mb-3">
                    <label for="tujuan" class="mb-2">Tujuan</label>
                    <input value="{{ $tujuan->to }}" id="tujuan" name="to_detail[]" placeholder="Input Tujuan.."
                        class="s-tugas form-control" type="text">
                </div>
                <div class="col-md-3 form-group mb-3">
                    <label for="waktu-sampai" class="mb-2">Waktu Sampai</label>
                    <input value="{{ $tujuan->to_time }}" id="waktu-sampai" name="to_time_detail[]" placeholder="Input Waktu Sampai.."
                        class="s-tugas form-control" type="datetime-local">
                </div>
            </div>
            @endforeach
            ...
            @foreach ($item->tugas[0]->pengikutTugas as $pengikut)
            <div class="row">
                <div class="col-md-5 form-group mb-3">
                    <label for="pengikut" class="mb-2">Nama</label>
                    <select name="pengikut[]" id="pengikut" class="s-tugas get-pengikut input form-control"></select>
                    @error('pengikut')
                        <div class='invalid-feedback d-inline'>
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-5 form-group mb-3">
                    ...
                    <input name="keterangan_pengikut[]" id="keterangan" name="keterangan_pengikut[]" placeholder="Input Keterangan Pengikut.."
                        class="s-tugas input form-control" type="text">
                </div>
            </div>
            @endforeach
