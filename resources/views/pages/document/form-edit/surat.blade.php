<div class="col-md-6">
    @if ($item->to_unit_kerja_id != null)
    <div class='form-group mb-3 unit-kerja'>
    ...
    @elseif ($item->to_user_id != null)
    <div class='form-group mb-3 personal'>
    ...
    <div class='form-group mb-3'>
        ...
        <textarea placeholder="Hal" name='hal' id='hal' cols='30' rows='5'
            class='form-control @error('hal') is-invalid @enderror'>{{ $item->hal }}</textarea>
        @error('hal')
...
<div class="col-md-6">
    ...
    <div class='form-group mb-2'>
        ...
        <textarea placeholder="Ringkasan" name='deskripsi' id='deskripsi' cols='30' rows='8'
            class='form-control @error('deskripsi') is-invalid @enderror'>{{ $item->deskripsi }}</textarea>
        @error('deskripsi')
            <div class='invalid-feedback'>
                {{ $message }}
            </div>
